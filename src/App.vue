  ...
  data() {
    return {
      ...
      calendar: {
        item: {
          one: {
            date: "3CZE<br /><span style='font-weight:normal;font-size:14px;'>2022</span>",
            type: "Arctic Chamber Music Festival<br /><span style='font-weight:normal;font-size:14px;'>Chopin Concerto No. 2 in F minor and Chamber Concerts </span>",
            location:
              "Royal Albert Hall<br /><span style='font-weight:normal;font-size:14px;'>London, UK</span>",
            ctaText: "MORE INFO",
          },
          two: {
            date: "17LIP<br /><span style='font-weight:normal;font-size:14px;'>2022</span>",
            type: "Recital",
            location:
              "Filharmonia Naradowa<br /><span style='font-weight:normal;font-size:14px;'>Warszawa, Polska</span>",
            ctaText: "TICKETS",
          },
          three: {
            date: "7AUG<br /><span style='font-weight:normal;font-size:14px;'>2022</span>",
            type: "Recital",
            location:
